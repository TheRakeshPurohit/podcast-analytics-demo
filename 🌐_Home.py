...
st.markdown(f"### 💡 Topics \n "
            ...
            "## How I built this \n"
            "* Transcription: [Assembly.ai](https://www.assemblyai.com/)\n"
            "* Language AI: [OneAI](https://www.oneai.com/), [Assembly.ai](https://www.assemblyai.com/), and [Huggingface](https://huggingface.co/)\n"
